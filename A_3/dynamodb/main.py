...
if __name__ == '__main__':
    ...
    # # print(item1)
    item2=dynamodb.createNewGame('121', '2', 'None', gamesTable)
    item2=dynamodb.createNewGame('11', '33', 'None', gamesTable)
    item2=dynamodb.createNewGame('12', '12', 'None', gamesTable)
    item2=dynamodb.createNewGame('111', '2', 'None', gamesTable)
    # print(item2)
    # games=dynamodb.getGamesWithStatus(2,'PENDING',gamesTable)
    # for g in games:
    #     print(g)
    invite=dynamodb.getGameInvites('None', gamesTable)
    print(invite)
    game1=dynamodb.acceptGameInvite(invite[0],gamesTable,1)
    print(game1)
    invite=dynamodb.getGameInvites('None', gamesTable)
    print(invite)
    game2=dynamodb.acceptGameInvite(invite[0],gamesTable,1)
    print(game2)
